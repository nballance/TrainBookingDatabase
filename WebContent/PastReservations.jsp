...
<table border=1>
	...
	try {
		...
		String query = "SELECT reservation_num, route_name, reservation_datetime, fare " +
		"FROM Reservation WHERE passenger = ? AND reservation_datetime < ? ORDER BY reservation_num";
	...
	<tr>
		...
		<td>
			<form method="post" action="RouteDetails.jsp">
				<input type="hidden" name="return" value="PastReservations.jsp">
